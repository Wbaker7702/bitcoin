...
BOOST_AUTO_TEST_CASE(merkleblock_construct_from_txids_found)
{
    ...
    txids.insert(Txid::FromUint256(txhash1));
    txids.insert(Txid::FromUint256(txhash2));
...
BOOST_AUTO_TEST_CASE(merkleblock_construct_from_txids_not_found)
{
    ...
    std::set<Txid> txids2;
    txids2.insert(Txid::FromUint256(uint256S("0xc0ffee00003bafa802c8aa084379aa98d9fcd632ddc2ed9782b586ec87451f20")));
