...
BOOST_AUTO_TEST_CASE(SimpleRoundTripTest)
{
    ...
    {
        CBlockHeaderAndShortTxIDs shortIDs{block, InsecureRandBits(64)};
...
public:
    ...
    explicit TestHeaderAndShortIDs(const CBlock& block) :
        TestHeaderAndShortIDs(CBlockHeaderAndShortTxIDs{block, InsecureRandBits(64)}) {}
    ...
    uint64_t GetShortID(const uint256& txhash) const {
        ...
        stream >> base;
        return base.GetShortID(Wtxid::FromUint256(txhash));
    }
